#!/usr/bin/env python3
"""
shared_selection_triton_exact_2.py

EXACT-MAX shared-PI kernel with MARGIN-WEIGHTED key ranking (variant of shared_selection_triton_exact.py).
Identical to the exact kernel except for HOW the shared top-X% key set is RANKED in Stage 2:
